/**
 * This class represents a piece for The Game http://en.wikipedia.org/wiki/The_Game_(mind_game) (not that game though). The piece is unique because the transform() method horizontally flips the piece. The cycle() method rotates the colors down. 
 * @author Joel May
 */
package hw3;
